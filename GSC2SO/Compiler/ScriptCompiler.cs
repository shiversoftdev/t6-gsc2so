...
namespace GameScriptCompiler_v3
{
    public partial class ScriptCompiler
    {
        ...
        //public static List<GlobalString> GlobalStrings = new List<GlobalString>();
        public static Dictionary<string, ushort> GlobalString;
        ...
        public static List<string> LocalVariables = new List<string>();
        public static List<Call> Calls = new List<Call>();
        public static List<int> JumpOnTrueExprList = new List<int>();
        public static List<Switch> Switches = new List<Switch>();
        public static List<Key> ArrayKeys = new List<Key>();
        public static byte numofForeachStatements = 0;
        public static byte numofParams = 0;
        ...
        public List<string> DevFuncs = new List<string>()
        {
            "print3d",
            "print",
            "println",
        ...
        public Random Rand;
        public GSC2SO.Form1 This;
        
        public ScriptCompiler(ParseTree tree, string path, Dictionary<string, List<string>> available_keys, GSC2SO.Form1 ths)
        {
        ...
        public bool Init()
        {
            ...
            {
                ERROR_MSG = string.Format("Bad syntax in line {0}.", Tree.ParserMessages[0].Location.Line);
                return false;
            }
            CompiledPub.AddRange(new byte[64]);
            AddString("Obfuscated by Serioushd-.gsc");
            ...
            file.NumofRefStrings = BitConverter.ToUInt16(BitConverter.GetBytes((ushort)RefStrings.Count).Reverse<byte>().ToArray<byte>(), 0);
            ...
            file.Size2 = BitConverter.ToInt32(BitConverter.GetBytes(CompiledPub.Count).Reverse<byte>().ToArray<byte>(), 0);
        ...
        private void EmitSwitchStatement(ParseTreeNode node)
        {
            ...
            CompiledPub.Replace(switchRangePos,
                BitConverter.GetBytes(CompiledPub.Count - switchRangePos - 4).Reverse<byte>().ToList());
