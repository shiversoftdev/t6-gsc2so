...
namespace GameScriptCompiler_v3_pc
{
    public partial class ScriptCompiler
    {
        ...
        //public static List<GlobalString> GlobalStrings = new List<GlobalString>();wel
        ...
        public bool Init()
        {
            ...
            file.NumofRefStrings = BitConverter.ToUInt16(BitConverter.GetBytes((ushort)RefStrings.Count).ToArray<byte>(), 0);
            WriteRefsToStringsToFile();
            file.Size = BitConverter.ToInt32(BitConverter.GetBytes(CompiledPub.Count).ToArray<byte>(), 0);
            file.Size2 = BitConverter.ToInt32(BitConverter.GetBytes(CompiledPub.Count).ToArray<byte>(), 0);
